        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/list-products" class="menu-link">
                    <div data-i18n="Without menu">View Product</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/add-products" class="menu-link">
                    <div data-i18n="Without menu">Add Procuct</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/list-news" class="menu-link">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                   <div class="avatar avatar-online">
                      <img src="{{url('Images/'.auth()->user()->thumbnail)}}" width="50px" height="50px" alt class="h-auto rounded-circle" />
                    </div>
                  </a>
